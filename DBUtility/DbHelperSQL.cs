...
namespace Accounts.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        //查询数据表中的一个字段
        public static DataSet search(string str, string table)
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                {
                    con.Open();
                    SqlDataAdapter sda = new SqlDataAdapter("select" + str + "from" + table, con);
        ...
        ///</summary>
        public static DataTable ExecuteSql1(string strSQL, int ParentID)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {

...
namespace Accounts.Web.ashx
{
    ...
    public class NavigationRole : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DataSet ds2 = Accounts.DBUtility.DbHelperSQL.Query("select Id,ButtonName from Com_ButtonGroup");
            DataSet ds4 = Accounts.DBUtility.DbHelperSQL.Query("select [RolesId],[NavigationId],ButtonId  FROM [Tb_RolesAndNavigation] where RolesId=" + RoleId);
            DataSet ds3 = Accounts.DBUtility.DbHelperSQL.Query("select NavigationId,ButtonId from Com_NavigationAndButton");

...
function arrowtag(namestr,size,style,valuestr,n,hiddenname)
{
  ...
  if(style!=""){
	  document.write("<input class='"+style+"' id='"+namestr+"' type='text' visible='false'  readonly name='"+namestr+"' value='"+valuestr+"' size='"+size+"' style='text-align: center;' style='Font-size: 9pt'>&nbsp;<Img src='datetime.gif' style='cursor:hand;' align='absmiddle' alt='弹出日历下拉菜单' onclick='fPopCalendar("+namestr+","+namestr+");return false'>");
  }else{
	  document.write("<input id='"+namestr+"' type='hidden'   name='"+namestr+"' value='"+valuestr+"' size='"+size+"' style='text-align: center;' style='Font-size: 9pt'>&nbsp;<Img src='datetime.gif' style='cursor:hand;' align='absmiddle' alt='弹出日历下拉菜单' onclick='fPopCalendar("+namestr+","+namestr+");return false'>");
  }
}

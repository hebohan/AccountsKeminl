...
function fSetDate(iYear, iMonth, iDay){
  ...
  if ((iYear == 0) && (iMonth == 0) && (iDay == 0)){
  	...
  	gdCtrl.value = iYear+"-"+iMonth+"-"+iDay+" "+tbSelHour.value+":"+tbSelMin.value;
  }
...
write("<font size='2'><b><font color='#99CCFF'>时间：");
...
write("<B style='color:"+gcBG+";cursor:hand; font-size:12px' onclick='fSetTime()' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=gcBG'>选择</B>");
write("</td></tr></table>");
write("</TD></TR>");
write("</TABLE></Div>");
}
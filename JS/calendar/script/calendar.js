...
with (document) {
    write("<Div id='VicPopCal' style='OVERFLOW:hidden;POSITION:absolute;VISIBILITY:hidden;border:0px ridge;width:100%;height:100%;top:0;left:0;z-index:100;overflow:hidden; padding-left:28px'>");
    write("<table style='border:2px solid #CAE8EA' bgcolor=''>");
    write("<TR>");
    ...
    write("<DIV style='#f2f2f2'><table width='100%' border='0'>");

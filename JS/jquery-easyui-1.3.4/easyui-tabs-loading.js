     ...
     * 加载iframe内容  
     ...
     loadTabIframe:function(jq,params){   
         return jq.each(function(){   
             ...
             var $maskMessage = $('<div class="mask-message" style="z-index:3;width:auto;height:16px;line-height:16px;position:absolute;top:50%;left:50%;margin-top:-20px;margin-left:-92px;border:2px solid #d4d4d4;padding: 12px 15px 10px 15px;background: #ffffff url(\'../../themes/defaultImages/loading.gif\') no-repeat scroll 5px center;">' + (params.iframe.message || '正在加载请等待···') + '</div>').appendTo($tabBody);   

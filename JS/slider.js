...
{ 
    ...
    this.height =document.getElementById(arguments[0]).offsetHeight; //arguments[2];//第三个参数：div的高度 
    this.width = document.getElementById(arguments[0]).offsetWidth;//arguments[3];//第四个参数：div的宽度 

...
var re=/\{(.[^\{]*)\}/ig;
if(!re.test(Msg))pltsTitle="<font color=#ffffff>内容</font>";
else{
re=/\{(.[^\{]*)\}(.*)/ig;
...
'<tr id=pltsPoptop ><th height=18 valign=bottom class=th1 ><b><p id=topleft align=left><font color=#ffffff>↖</font><font color=blue>'+pltsTitle+'</font></p><p id=topright align=right style="display:none">'+pltsTitle+'<font color=#ffffff>↗</font></b></th></tr>'+

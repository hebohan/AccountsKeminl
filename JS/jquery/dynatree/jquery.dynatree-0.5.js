...
//		return $("#" + this.options.idPrefix + key).attr("dtnode");
	...
	getAllSelectedNodes: function(stopOnParents) {  //得到包括部分选择的node  wgj2009
		
			var nodeList = [];//实现部分选择的
			this.tnRoot.visit(function(dtnode){
			 ...
			 $.merge(nodeList,this.selectedNodes);			 
			return nodeList;
...
$.ui.dynatree.getter = "getTree getRoot getActiveNode getSelectedNodes getAllSelectedNodes";//增加

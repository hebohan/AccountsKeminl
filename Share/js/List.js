...
document.onreadystatechange = function () {
    if (document.readyState == "complete" || document.readyState == "interactive") {
        ...
        TableChangeBg("ListData", "#FAFEFF", "#EBF6FA", "#FFFFA4", "#FC6", "#333", "#333", 2);
        TableChangeBg("XsListData", "#FAFEFF", "#EBF6FA", "#FFFFA4", "#FC6", "#333", "#333", 2);
        TableChangeBg("XKListData", "#FAFEFF", "#EBF6FA", "#FFFFA4", "#FC6", "#333", "#333", 2);
        TableChangeBg("BKListData", "#FAFEFF", "#EBF6FA", "#FFFFA4", "#FC6", "#333", "#333", 2);
        TableChangeBg("ListAdvSearch", "#FAFEFF", "#EBF6FA", "#FFFFA4", "#FC6", "#333", "#333", 1);


        addtdTitle("ListData", 1);
        addtdTitle("XsListData", 1);
        addtdTitle("XKListData", 1);
        addtdTitle("BKListData", 1);
        ...
        resizetHead("XsListData");
        resizetHead("XKListData");
        resizetHead("BKListData");
...
function MouseDownToResize() {
    ...
    if (this.setCapture) {
        ...
        document.addEventListener("mousemove", MouseMoveToResize, true);
        document.addEventListener("mouseup",MouseUpToResize, true);
    };
}
function MouseMoveToResize() {
    ...
    if (newWidth > 0) {
        $(this).css("width", newWidth);//原先的this.style.width只在IE下有效
...
function MouseUpToResize() {
    ...
    if (this.releaseCapture) {
        ...
        //document.removeEventListener("mousemove", MouseMoveToResize, true);
        //document.removeEventListener("mouseup", MouseUpToResize, true);
    }
    this.mouseDownX = 0;
    //   if (this.parentElement.parentElement.parentElement.id == "ListData") {
    FixFlowTitle("ListTableFlow", "ListData");

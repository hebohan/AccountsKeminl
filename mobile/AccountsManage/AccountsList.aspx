<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsList.aspx.cs" Inherits="Accounts.Web.mobile.AccountsManage.AccountsList" %>
...
<html>
	<head>
		...
		<title>账单管理 - 账单管理系统 Keminl.cn</title>
        ...
        <script type="text/javascript">
            function getdata(page) {
                ...
                //$("#more").attr("style", "font-size:13px;text-align:center");
                ...
                $.ajax({
                    type: "post",
                    url: "/tools/do_ajax.ashx?action=getalist",
                    data: { "userid": userid, "page": page ,"type":type,"status":status,"keyword":keyword},
                    dataType: "text",
                    success: function (data) {
                        ...
                        if (content != "") {
                            //$("#more").attr("style", "font-size:13px;");
	...
	<body class="am-background-disable">
		<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
			...
			<h1 class="am-header-title">
    			<a href="#title-link" style="font-size:16px;padding-top:0px">账单列表</a>
  			</h1>
            <%=Menu %>
		</header>
        <form runat="server">
        ...
        <!-- 账单显示区域 -->
            <table class="hei12" style="font-size:10px;height:30px;width:100%;">
                <tr>
                    <td style="width:18%;padding-left:10px;padding-top:5px">账单类型：</td>
                    <td style="padding-top:5px">
                            <div style="width:90%">
                                <select ID='ddlType' runat='server'></select>
                            </div>
                    </td>
                    <td class="stitle" style="width:12%;padding-top:5px">状态：</td>
                    <td style="padding-top:5px">
                            <div style="width:100%;padding-right:10px">
                                <select ID="ddlStatus" runat="server"></select>
                            </div>
                    </td>

                </tr>
                <tr>
                    <td style="width:18%;padding-left:10px;padding-top:5px">关键字：</td>
                    <td style="padding-top:5px">
            ...
            <div style="padding-top:10px;background-color:white;padding-bottom:10px;">
                <h1 style="text-align:center;font-size:15px">账单列表(共<font color="red" id="countnum"></font>条)</h1>
            ...
            <%--<div class="bl_more" style="background-color:white"><span class="account_more" style="font-size:13px;text-align:center" id="more"></span></div>--%>
        </form>

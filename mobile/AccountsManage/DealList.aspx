<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealList.aspx.cs" Inherits="Accounts.Web.mobile.AccountsManage.DealList" %>
...
<html>
	<head>
		...
		<title>交易记录 - 账单管理系统 Keminl.cn</title>
        ...
        <script type="text/javascript">
            function getdata(page) {
                ...
                $.ajax({
                    type: "post",
                    url: "/tools/do_ajax.ashx?action=getplist",
                    data: { "userid": userid, "page": page, "order": order, "sdate": sdate, "edate": edate },
                    dataType: "text",
	...
	<body class="am-background-disable">
		<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
			...
			<h1 class="am-header-title">
    			<a href="#title-link" style="font-size:16px;padding-top:0px">交易记录</a>
  			</h1>
            <%=Menu %>
		</header>
        <form runat="server">
        ...
        <!-- 账单显示区域 -->
            ...
            <div style="padding-top:10px;background-color:white;padding-bottom:10px;">
                <h1 style="text-align:center;font-size:15px">交易记录(共<font color="red" id="countnum"></font>条)</h1>

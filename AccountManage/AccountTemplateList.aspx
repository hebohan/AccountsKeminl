<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountTemplateList.aspx.cs" Inherits="Accounts.Web.AccountManage.AccountTemplateList" %>
        ...
        <div id="MainCont">
            ...
            <cc1:WebGridView CssClass="ListTable hei12" ID="ListData" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <ItemTemplate >
                        <a href="AccountTemplateDetail.aspx?id=<%# DataBinder.Eval(Container,"DataItem.id")%>"><%# DataBinder.Eval(Container,"DataItem.name")%></a>
                    </ItemTemplate>
                    </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountDetail.aspx.cs" Inherits="Accounts.Web.AccountManage.AccountDetail" %>
    ...
    <form id="form1" runat="server">
        <div id="MainCont">
            ...
            <div style="width: 100%; overflow-x: scroll;">
                <table id="field_tab_content" class="ListTable ListSearch hei12" style="margin-left:auto;margin-right:auto">
                    <%=field_tab_content %>
                </table>
            </div>

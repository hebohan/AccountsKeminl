<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountRegisterList.aspx.cs" Inherits="Accounts.Web.AccountsManage.AccountRegisterList" %>
        ...
        <div id="MainCont">
            ...
            <cc1:WebGridView CssClass="ListTable hei12" ID="ListData" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <ItemTemplate >
                        <a href="AccountRegisterDetail.aspx?tempid=<%# DataBinder.Eval(Container,"DataItem.id")%>"><%# DataBinder.Eval(Container,"DataItem.name")%></a>
                    </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <ItemTemplate >
                        ...
                        <a href="AccountRegisterDetail.aspx?type=1&tempid=<%# DataBinder.Eval(Container,"DataItem.id")%>">录入</a>
                    </ItemTemplate>
                    </asp:TemplateField>
                </Columns>

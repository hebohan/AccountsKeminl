<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictionaryList.aspx.cs" Inherits="Accounts.Web.DictionaryManage.DictionaryList" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenNewForm() {
            window.open("DictionaryDetail.aspx", '_blank', "width=800,height=700,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no");
        }
        ...
        <div id="MainCont">
            ...
            <cc1:WebGridView CssClass="ListTable hei12" ID="ListData" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <ItemTemplate >
                        <a href="DictionaryItemList.aspx?id=<%# DataBinder.Eval(Container,"DataItem.Dicid")%>"><%# DataBinder.Eval(Container,"DataItem.DicName")%></a>
                    </ItemTemplate>
                    </asp:TemplateField>
                     <asp:BoundField DataField="DicCode" HeaderText="代码">
                        <HeaderStyle Wrap="False" Width="20%" />
                        <ItemStyle Wrap="False" Width="20%" HorizontalAlign="Left" />
                    </asp:BoundField>

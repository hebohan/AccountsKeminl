<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictionaryDetail.aspx.cs" Inherits="Accounts.Web.DictionaryManage.DictionaryDetail" %>
            ...
            <table class="ListSearch hei12">
                <tr>
                    ...
                    <td class="inputtdline">
                        <asp:TextBox ID="tb_name" runat="server" class="left detail_edit" datatype="*" nullmsg="请输入名称"></asp:TextBox>
                    </td>

...
namespace Accounts.DAL
{
	...
	public partial class Com_NavigationAndButton
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("NavigationId", "Com_NavigationAndButton"); 
		}
...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public Accounts.Model.Com_NavigationAndButton GetModel(int NavigationId,int ButtonId)
		{
			...
			Accounts.Model.Com_NavigationAndButton model=new Accounts.Model.Com_NavigationAndButton();

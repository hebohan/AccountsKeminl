<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDetail.aspx.cs" Inherits="Accounts.Web.OrderManage.OrderDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div id="MainCont" style="overflow-y:scroll;height:200px;min-width:350px;">
            <table class="ListSearch hei12" style="table-layout:fixed;width:270px;padding-left:25px" >
                    <%=hidcontent.Value %>
            </table>
        </div>
